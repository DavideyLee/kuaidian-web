  ...
  <div class="panel">
    ...
    <div class="panel-body" v-loading="load_data" element-loading-text="拼命加载中">
      <el-form label-width="100px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="任务标题:">{{task.Title}}</el-form-item>
            <span v-if="project.RepoType=='git'">
              <div v-if="task.Branch===''">
                <el-form-item label="Tag标签:">{{task.CommitId}}</el-form-item>
              </div>
              <div v-else>
            ...
            <span v-if="project.RepoType=='jenkins'">
              <el-form-item label="构建名称:">{{task.Branch}}</el-form-item>
              <el-form-item label="包地址:">{{task.CommitId}}</el-form-item>
            </span>
          ...
          <el-col :span="12">
            ...
            <el-form-item label="部署路径:">{{project.ReleaseTo}}</el-form-item>
            <el-form-item label="发布版本库:">{{project.ReleaseLibrary}}</el-form-item>
            <el-form-item label="发布服务器组:" v-if="groups.length>0">
              <span v-for="n in groups">
                {{ n }}
                <br />
              </span>
            </el-form-item>
