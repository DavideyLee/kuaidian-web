      ...
      <el-row>
        <el-col :span="20">
          <el-form label-width="100px">
            ...
            <el-form-item>
              <el-button type="primary" @click="on_git_log" :loading="on_submit_loading">查询</el-button>
              <el-button type="primary" @click="on_submit_form" :loading="on_submit_loading">更新</el-button>
        ...
        .then(({ data: { data } }) => {
          ...
          for (var i in data.table_data) {
            if (data.table_data[i].level == 2) {
              ...
              var env = ''
              switch (data.table_data[i].level) {
                case '2':
                  env = '验收环境'
                  break
                case '3':
