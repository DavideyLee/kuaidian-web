      ...
      >
        ...
        <el-table-column label="操作" width="300" align="center">
          <template scope="props">
            ...
            <router-link
              :to="{name: 'taskRelease', params: {id: props.row.id}}"
              v-if="props.row.status!='上线中'&&props.row.status!='上线完成'"
              tag="span"
            >
            ...
            <el-button
              ...
              size="small"
              icon="share"
              @click="create_rollback(props.row.id)"
            ...
            <el-button
              ...
              size="small"
              icon="share"
              @click="create_rollback_this(props.row.id)"
              v-if="props.row.status=='上线完成'&&props.row.action=='0'&&props.row.enable_rollback=='1' "
            >回滚到当前</el-button>
            <el-button
              type="danger"
