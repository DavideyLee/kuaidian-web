            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="项目名称:" prop="Name" label-width="100px">
                  <el-input v-model="form.Name" placeholder="请输入项目名称" style="width: 600px;"></el-input>
                </el-form-item>
                ...
                <el-form-item label="项目环境:" label-width="100px">
                  <el-radio-group v-model="form.Level">
                    <el-radio :label="2">验收环境</el-radio>
                    <el-radio :label="3">生产环境</el-radio>
                  </el-radio-group>
                </el-form-item>
                  ...
                  <div class="el-form--label-top">
                    ...
                    <el-form-item label="版本保留数:" prop="KeepVersionNum">
                      <el-tooltip
                        class="item"
                        effect="dark"
                        content="过多的历史版本将被删除，只可回滚保留的版本"
                        placement="top"
                      >
                        <el-input-number
                          v-model="form.KeepVersionNum"
                          placeholder="20"
                          style="width: 400px;"
                          :max="100"
                          :min="1"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        DeployFrom: [
          { required: true, message: '代码检出仓库不能为空', trigger: 'blur' }
        ],
        ReleaseUser: [
          {
            required: true,
            message: '目标机器部署代码用户不能为空。',
            trigger: 'blur'
          }
        ],
        ReleaseTo: [
          { required: true, message: '代码的webroot不能为空', trigger: 'blur' }
        ],
        ReleaseLibrary: [
          { required: true, message: '发布版本库不能为空。', trigger: 'blur' }
        ],
        Hosts: [
          { required: true, message: '机器列表不能为空。', trigger: 'blur' }
        ]
      }
    }
  },
          ...
          for (var i in this.hosts) {
            ...
            for (var j = 0; j < shosts.length; j++) {
              ...
              if (shosts[j] && shosts[j] != '') {
                this.form.Hosts =
                  this.form.Hosts + count + '#' + shosts[j] + '\r\n'
              }
            }
          }
