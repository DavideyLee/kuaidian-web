          ...
          <template scope="props">
            <el-popover ref="popover4" placement="left-start" width="620" trigger="click">
              <div style="margin-left:10px;font-size:15px">
                ...
                <span style="margin-left:8px;color:#20A0FF">项目详情</span>
              </div>
                ...
                <div class="loginWarpa">
                  <div class="login-forma">
                    <el-form ref="form" label-width="0">
                      ...
                      >
                        <label>项目名称 ：</label>
                        <span style="color:teal">{{project_data.Name}}</span>
                      </el-form-item>
                      <el-form-item
                        prop="old_password"
                        class="login-itema"
                      ...
                      >
                        <label>项目环境 ：</label>
                        <span style="color:teal">{{project_data.Level == 3 ? '生产环境' : '验收环境'}}</span>
                      </el-form-item>
                      <el-form-item
                        prop="old_password"
                        class="login-itema"
                      ...
                      >
                        <label>项目地址 ：</label>
                        <span style="color:teal">{{project_data.RepoUrl}}</span>
                      </el-form-item>
                    </el-form>
                  </div>
                </div>
              ...
              <div style="margin-left:10px;font-size:15px">
                <i class="ace-icon fa fa-desktop" style="color:#F7BA21"></i>
                <span style="margin-top:-20px;margin-left:8px;color:#F7BA2A">宿主机</span>
              </div>
              <div class="login-bodya">
                <div class="loginWarpa">
                  <div class="login-forma">
                    <el-form ref="form" label-width="0">
                      ...
                      >
                        <label>代码检出仓库 ：</label>
                        <span style="color:teal">{{project_data.DeployFrom}}</span>
                      </el-form-item>
                      <el-form-item
                        prop="old_password"
                        class="login-itema"
                      ...
                      >
                        <label>排除文件 ：</label>
                        <span style="color:teal">{{project_data.Excludes}}</span>
                      </el-form-item>
                    </el-form>
                  </div>
                </div>
              ...
              <div style="margin-left:10px;font-size:15px">
                <i class="el-icon-menu" style="color:#13CE66"></i>
                <span style="margin-top:-20px;margin-left:8px;color:#13CE66">机器列表</span>
              </div>
              <div class="login-bodya">
                <div class="loginWarpa">
                  <div class="login-forma">
                    <el-form ref="form" label-width="0">
                      ...
                      >
                        <label>用户 ：</label>
                        <span style="color:teal">{{project_data.ReleaseUser}}</span>
                        <label style="margin-left:120px">保留版本数 ：</label>
                        <span style="color:teal">{{project_data.KeepVersionNum}}</span>
                      </el-form-item>
                      ...
                      >
                        <label>webroot ：</label>
                        <span style="color:teal">{{project_data.ReleaseTo}}</span>
                      </el-form-item>
                      ...
                      >
                        <label>发布版本库 ：</label>
                        <span style="color:teal">{{project_data.ReleaseLibrary}}</span>
                      </el-form-item>
                      ...
                      >
                        <label>机器列表 ：</label>
                        <span style="color:teal">{{project_data.Hosts}}</span>
                      </el-form-item>
                    </el-form>
                  </div>
                </div>
              ...
              <div style="margin-left:10px;font-size:15px">
                <i class="el-icon-setting" style="color:#FF4949"></i>
                <span style="margin-top:-20px;margin-left:8px;color:#FF4949">高级任务</span>
              </div>
              <div class="login-bodya">
                <div class="loginWarpa">
                  <div class="login-forma">
                    <el-form ref="form" label-width="0">
                      ...
                      >
                        <label>代码检出前任务 ：</label>
                        <span style="color:teal">{{project_data.PreDeploy}}</span>
                      </el-form-item>
                      ...
                      >
                        <label>代码检出后任务 ：</label>
                        <span style="color:teal">{{project_data.PostDeploy}}</span>
                      </el-form-item>
                      ...
                      <el-form-item
                        ...
                        style="margin-top:-20px;margin-left:-25px"
                      >
                        <label>同步完目标机后任务 ：</label>
                        <span style="color:teal">{{project_data.PreRelease}}</span>
                      </el-form-item>
                      ...
                      <el-form-item
                        ...
                        style="margin-top:-20px;margin-left:-25px"
                      >
                        <label>更改版本软链接后任务 ：</label>
                        <span style="color:teal">{{project_data.PostRelease}}</span>
                      </el-form-item>
                      ...
                      >
                        <el-form-item>
                          <label>部属方式 ：</label>
                          <span style="color:teal">{{project_data.ReleaseType== 0 ? '软链接' : '移动目录'}}</span>
                        </el-form-item>
                        <el-form-item>
                          <label>是否开启p2p ：</label>
                          <span style="color:teal">{{project_data.P2p== 0 ? 'No' : 'Yes'}}</span>
                        </el-form-item>
                        <el-form-item>
                          <label>是否开启gzip ：</label>
                          <span style="color:teal">{{project_data.Gzip == 0 ? 'No' : 'Yes'}}</span>
                        </el-form-item>
                      </el-form-item>
                    </el-form>
                  </div>
